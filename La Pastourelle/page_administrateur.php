    ...
    echo "
		<DIV id=\"menu2\">
			<CENTER><B><BR>
				...
				Modifier :
				<A class='btn btn-link' HREF='index.php?page=change_txt'>Un texte</A>&nbsp;&nbsp; &nbsp;&nbsp;				<a class='btn btn-link' href='index.php?page=change_phrasejour'>La phrase de la semaine</a>&nbsp;&nbsp; &nbsp;&nbsp;
	        <br /><br />
			<A class='btn btn-link' HREF='index.php?page=gest_content'>Importer du contenu</A>
			</CENTER>
			</B>
		</DIV>
		<br />";
