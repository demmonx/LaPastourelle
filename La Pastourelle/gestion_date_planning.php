...
if (count($info_date) <= 0) {
    ...
    echo "<FORM METHOD='POST' id='modif' ACTION='traitement_date_planning.php'>
			<TABLE >
...
echo "<A class='btn btn-link' HREF='index.php?page=page_planning'>Retour à la page précédente</A>";
?>