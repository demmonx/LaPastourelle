...
document.write('.popper {  VISIBILITY: hidden; z-index:3; }')
document.write('#topgauche {  z-index:10; }')
document.write('A:hover.ejsmenu {color:#FFFFFF; text-decoration:none;}')
document.write('A.ejsmenu {color:#FFFFFF; text-decoration:none;}')
document.write('</style>')
document.write('<div style="height:25"><DIV class=popper id=topdeck></DIV>');
...
document.write('<TD WIDTH=120 ALIGN=center BGCOLOR='+bgcolor9+' onMouseOver="this.style.background=\''+bgcolor2+'\';pop(zlien[0],0)" onMouseOut="this.style.background=\''+bgcolor9+'\'"><A onClick="return(false)" onMouseOver="pop(zlien[0],0)" href=# CLASS=ejsmenu><FONT SIZE=1 font-weight="bold" FACE="Verdana"><A HREF="index.php?page=page_administrateur" CLASS=ejsmenu>ADMINISTRATION</A></FONT></a></TD>')
