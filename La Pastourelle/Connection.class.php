...
class Connection extends PDO
{
    ...
    private $email = 'artotal@gmail.com';
    // email de l'admin du site
    private $dns;

    public function __construct ()
    {
        try {
            $this->con = parent::__construct($this->getDns(), $this->user, 
                    $this->pwd);
    ...
    public function selectTableau ($reqSelect)
    {
        ...
        $result->execute();
        /*
         * RÃ©cupÃ©ration de toutes les lignes d'un jeu de rÃ©sultats
         * "Ã©quivalent Ã  mysql_num_row() "
         */
