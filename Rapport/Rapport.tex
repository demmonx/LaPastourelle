...
pourra pas accéder aux modules d'administration. \\
 ...
 \par Enfin, il nous a fallu recpder
 
 \subsection{Convention de nommage}
 Pour nommer les fichiers et nous y retrouver, nous avons pris la règle suivant
 : \\
 \begin{itemize}
   \item inc.x.php pour tous les fichiers devant être inclus
   \item class.x.php pour tous les fichiers objets
   \item page_x.php pour tous les fichiers qui ne concernent pas
   l'adminisitration
   \item gestion_x.php pour tous les formulaires d'administration
   \item traitement_x.php pour tous les fichiers de traitement de formulaire \\
 \end{itemize}
