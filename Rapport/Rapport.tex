...
\renewcommand{\thesubsubsection}{\Alph{chapter}.\Roman{section}.\arabic{
subsection}.\alph{subsubsection})}
\parskip 5pt
...
\include{include/Liste_tache_8-12}
\begin{landscape}
\begin{figure}[t]
...
\includepdf{include/suivi_charge.pdf}

\subsubsection*{Répartition du travail}
Considérons le diagramme suivant : \\
\begin{figure}[H] \centering{
    \caption{Répartition du temps de travail (en heures)}}
...
\begin{landscape}
\includepdf{include/COPIL1.pdf}
\end{landscape}
\clearpage

\begin{landscape}
\includepdf{include/recette1.pdf}
\end{landscape}
\clearpage
...
\includepdf[pages={-}]{include/etude_graphique.pdf}
...
\includepdf[pages={-}, landscape=true]{include/charte_graphique.pdf}
...
\includepdf{include/diagramme_sql.pdf}
\include{include/sql-logique}
\begin{multicols}{2}
...
\lstinputlisting[
        ...
        extendedchars=true
        ]{include/rapport-pastourebd.sql}
        \end{multicols}
...
\begin{figure}[htp] \centering{
\includegraphics[scale=1]{include/screen/postgres_login.png}}
...
\begin{figure}[H] \centering{
\includegraphics[scale=0.6]{include/screen/postgres_export.png}}
...
d'action
    ...
    \begin{figure}[H] \centering{
\includegraphics[scale=0.6]{include/screen/drop_table.png}}
...
tables avec des dépendances ne pourront pas être supprimées
    ...
    \begin{figure}[H] \centering{
\includegraphics[scale=0.6]{include/screen/cascade.png}}
...
correspond à la sauvegarde de la base de donnée que vous voulez restaurer
    \begin{figure}[H] \centering{
\includegraphics[scale=0.6]{include/screen/import.png}}
...
Voir page suivante
\includepdf[pages={-}]{include/user_manual.pdf}
\end{document}